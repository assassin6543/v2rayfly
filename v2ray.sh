...
wget -O ${DOWNLOAD_PATH}/v2ray.zip https://github.com/assassin6543/v2ray-core/releases/download/${TAG}/${V2RAY_FILE} >/dev/null 2>&1
wget -O ${DOWNLOAD_PATH}/v2ray.zip.dgst https://github.com/assassin6543/v2ray-core/releases/download/${TAG}/${DGST_FILE} >/dev/null 2>&1
